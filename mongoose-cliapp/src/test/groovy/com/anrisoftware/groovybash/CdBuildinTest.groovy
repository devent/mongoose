 ...
 * @since 0.1
 */
class CdBuildinTest extends ScriptTestUtils {

	@Test
	void "cd buildin with no arguments"() {
		def script = """
cd
"""
	...
	@Test
	void "cd buildin with no arguments return value"() {
		def script = """
ret = cd
echo ret
"""
	...
	@Test
	void "cd buildin with directory"() {
...
"""
	...
	@Test
	void "cd buildin with not existent directory"() {
		def tmp = createTempDirectory()
...
"""
	...
	@Test
	void "cd buildin with not existent directory catch exception"() {
		def tmp = createTempDirectory()
		assert tmp.deleteDir()
		def script = """
try {
