...
/**
 * Returns the build-in command {@code info}.
 * 
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 0.1
 */
public class InfoPlugin implements BuildinPlugin {
	...
	private void lazyCreateInjector(Injector parentInjector) {
		if (injector == null) {
			injector = parentInjector.createChildInjector(new InfoModule());
		}
	}
}
