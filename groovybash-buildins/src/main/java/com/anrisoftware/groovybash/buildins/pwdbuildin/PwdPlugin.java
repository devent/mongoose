...
/**
 * Returns the build-in command {@code pwd}.
 * 
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 0.1
 */
public class PwdPlugin implements BuildinPlugin {
	...
	private void lazyCreateInjector(Injector parentInjector) {
		if (injector == null) {
			injector = parentInjector.createChildInjector(new PwdModule());
		}
	}
}
