...
/**
 * Returns the build-in command {@code listFiles}.
 * 
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 0.1
 */
public class ListFilesPlugin implements BuildinPlugin {
	 ...
	 * 
	 * @return the name {@code listFiles}.
	 */
	@Override
	...
	private void lazyCreateInjector(Injector parentInjector) {
		if (injector == null) {
			injector = parentInjector
					.createChildInjector(new ListFilesModule());
		}
	}
}
