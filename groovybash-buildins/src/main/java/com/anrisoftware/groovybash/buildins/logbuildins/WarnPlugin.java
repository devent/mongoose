...
/**
 * Returns the build-in command {@code warn}.
 * 
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 0.1
 */
public class WarnPlugin implements BuildinPlugin {
	...
	private void lazyCreateInjector(Injector parentInjector) {
		if (injector == null) {
			injector = parentInjector.createChildInjector(new WarnModule());
		}
	}
}
