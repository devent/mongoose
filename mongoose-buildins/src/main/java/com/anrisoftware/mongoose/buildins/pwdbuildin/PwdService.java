...
/**
 * Makes the build-in command {@code pwd} available as a service.
 * 
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 1.0
 */
@ProviderFor(CommandService.class)
public class PwdService implements CommandService {

	/**
	 * The unique identifier of the build-in command {@code pwd}.
	 */
	public static final String ID = "pwd";

	/**
	 * The command information of the build-in command {@code pwd}.
	 */
	...
	private static final Module[] MODULES = new Module[] { new PwdModule() };
