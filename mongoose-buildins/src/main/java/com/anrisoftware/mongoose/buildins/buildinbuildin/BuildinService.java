...
/**
 * Makes the build-in command {@code buildin} available as a service.
 * 
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 1.0
 */
@ProviderFor(CommandService.class)
public class BuildinService implements CommandService {

	/**
	 * The unique identifier of the build-in command {@code buildin}.
	 */
	public static final String ID = "buildin";

	/**
	 * The command information of the build-in command {@code buildin}.
	 */
	...
	private static final Module[] MODULES = new Module[] { new BuildinModule() };
