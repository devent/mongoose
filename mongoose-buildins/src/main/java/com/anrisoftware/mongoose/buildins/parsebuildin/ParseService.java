...
/**
 * Makes the build-in command {@code parse} available as a service.
 * 
...
public class ParseService implements CommandService {
	...
	/**
	 * The unique identifier of the build-in command {@code parse}.
	 */
	public static final String ID = "parse";

	/**
	 * The command information of the build-in command {@code parse}.
	 */
	...
	private static final Module[] MODULES = new Module[] { new ParseModule() };
