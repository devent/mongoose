...
/**
 * Makes the build-in command {@code sudo} available as a service.
 * 
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 1.0
 */
@ProviderFor(CommandService.class)
public class SudoService implements CommandService {

	/**
	 * The unique identifier of the build-in command {@code sudo}.
	 */
	public static final String ID = "sudo";

	/**
	 * The command information of the build-in command {@code sudo}.
	 */
	...
	private static final Module[] MODULES = new Module[] { new SudoModule() };
