...
/**
 * Makes the build-in command {@code create} available as a service.
 * 
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 1.0
 */
@ProviderFor(CommandService.class)
public class CreateService implements CommandService {

	/**
	 * The unique identifier of the build-in command {@code create}.
	 */
	public static final String ID = "create";

	/**
	 * The command information of the build-in command {@code create}.
	 */
	...
	private static final Module[] MODULES = new Module[] { new CreateModule() };
