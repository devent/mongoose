...
public class ListFilesService implements CommandService {

	/**
	 * The unique identifier of the build-in command {@code listFiles}.
	 */
	public static final String ID = "listFiles";

	/**
	 * The command information of the build-in command {@code listFiles}.
	 */
