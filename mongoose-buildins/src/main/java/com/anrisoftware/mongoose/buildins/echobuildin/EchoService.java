...
/**
 * Makes the build-in command {@code echo} available as a service.
 * 
...
public class EchoService implements CommandService {
	...
	/**
	 * The unique identifier of the build-in command {@code echo}.
	 */
	public static final String ID = "echo";

	/**
	 * The command information of the build-in command {@code echo}.
	 */
	...
	private static final Module[] MODULES = new Module[] { new EchoModule() };
