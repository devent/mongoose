...
public class ExecutionException extends CommandException {
     ...
     */
    public ExecutionException(Object message, Throwable cause, int exitValue) {
        super(message, cause);
     ...
     */
    public ExecutionException(Object message, int exitValue) {
        super(message);
        add(EXIT_VALUE_KEY, exitValue);
    }
     ...
     */
    @Override
    public ExecutionException add(Object name, Object value) {
